package com.example.dndhelper.model.localDataSources
...
interface LocalDataSource {
    ...
    fun getClasses(classes : MutableLiveData<List<com.example.dndhelper.model.Class>>): MutableLiveData<List<com.example.dndhelper.model.Class>>
...
class LocalDataSourceImpl(val context: Context) : LocalDataSource {
    ...
    private val _races: MutableLiveData<List<Race>> =
        MutableLiveData()
    private val _classes: MutableLiveData<List<com.example.dndhelper.model.Class>> =
        MutableLiveData()
    ...
    override fun getClasses(classes: MutableLiveData<List<com.example.dndhelper.model.Class>>): MutableLiveData<List<com.example.dndhelper.model.Class>> = _classes
    ...
    private fun generateClasses() {
        ...
        val classes = mutableListOf<com.example.dndhelper.model.Class>()
        val rootJson = JSONObject(dataAsString)
