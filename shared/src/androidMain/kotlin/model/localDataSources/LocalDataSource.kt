...
class LocalDataSourceImpl constructor(
    ...
    private suspend fun generateItemProficiencies() {
        val rootJson = JSONObject(
            Res.readBytes("raw/item_proficiencies").toString()
        )
    ...
    private suspend fun generateFightingStyles() {
        val dataAsString =
            Res.readBytes("raw/fighting_styles").toString()
    ...
    private suspend fun generateMetaMagic() {
        ...
        val dataAsString =
            Res.readBytes("raw/metamagic").toString()
    ...
    private suspend fun generateManeuvers() {
        val dataAsString =
            Res.readBytes("raw/maneuvers").toString()
    ...
    private suspend fun generateInvocations() {
        val dataAsString =
            Res.readBytes("raw/invocations").toString()
    ...
    private suspend fun generateInfusions() {
        val dataAsString =
            Res.readBytes("raw/infusions").toString()
    ...
    private suspend fun generateFeats() {
        val dataAsString =
            Res.readBytes("raw/feats").toString()
    ...
    private suspend fun generateItems() {
        ...
        _martialWeapons.value = generateWeapons(
            Res.readBytes("raw/martial_weapons").toString(),
            true
        )
        ...
        _simpleWeapons.value = generateWeapons(
            Res.readBytes("raw/simple_weapons").toString(),
            false
        )
    ...
    private suspend fun generateMiscItems(): List<ItemInterface> {
        val dataAsString =
            Res.readBytes("raw/misc_items").toString()
        val result = mutableListOf<ItemInterface>()
    ...
    private suspend fun generateArmor(): List<Armor> {
        val dataAsString =
            Res.readBytes("raw/armor").toString()
    ...
    private suspend fun generateSkills() {
        val dataAsString =
            Res.readBytes("raw/skills").toString()
    ...
    private suspend fun updateSpells() {
        val dataAsString =
            Res.readBytes("raw/spells").toString()
    ...
    private suspend fun generateLanguages() {
        val dataAsString =
            Res.readBytes("raw/languages").toString()
    ...
    private suspend fun updateBackgrounds() {
        val dataAsString =
            Res.readBytes("raw/backgrounds").toString()
    ...
    private suspend fun updateRaces() {
        val dataAsString =
            Res.readBytes("raw/races").toString()
    ...
    private suspend fun updateClasses() {
        val dataAsString =
            Res.readBytes("raw/classes").toString()
